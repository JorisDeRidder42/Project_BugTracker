#pragma checksum "D:\Project_BugTracker\Project_BugTracker\BugTracker\Views\Home\Help.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "762533ef5e9348d3ac35214bb514c7bd284fbf95"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"762533ef5e9348d3ac35214bb514c7bd284fbf95", @"/Views/Home/Help.cshtml")]
    ...
    public class Views_Home_Help : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "D:\Project_BugTracker\Project_BugTracker\BugTracker\Views\Home\Help.cshtml"
...
#nullable disable
            WriteLiteral("<h1>");
#nullable restore
#line 4 "D:\Project_BugTracker\Project_BugTracker\BugTracker\Views\Home\Help.cshtml"
...
<p>
    ...
    “Defect tracking is an important process in software engineering, as complex and business critical systems have hundreds of defects,” says Tutorials Point. “One of the challenging factors is managing, evaluating and prioritizing these defects. The number of defects ge");
            WriteLiteral(@"ts multiplied over a period of time and to effectively manage them, a defect tracking system is used to make the job easier.""
...
<ul>
    ...
    <li>Test: Fixed and re");
            WriteLiteral(@"ady for testing</li>
...
<ul>
    ...
    <li>Failure of non-critical systems: A reasonably satisfactory workaround exists. The product may be released, if the bug is documented.</li>
    <li>Very minor: There is a workaround, or the issue can be ignored. It does not impact a product release.<");
            WriteLiteral(@"/li>
...
<p>
    ...
    Software testing is essential for isolating and mitigating errors. A good QA process can uncover hundreds or even thousands of defects, and testing teams need to manage all of them. Integrating bug tracking into the testing workflow improves efficiency by helping testers prioritize, monitor and report on the");
            WriteLiteral(@" status of each error.
    ...
    Many teams are now using a methodology known as continuous testing. In this case, quality testing and feedback are conducted at all stages of development, from design and coding to deployment. Modern technologies like artificial intelligence (A");
            WriteLiteral(@"I) too can aid the testing process by detecting and analyzing bugs early in the lifecycle.
</p>
...
<p>
    ...
    In the Harvard Business Review, Nicholas Bowen outlines a process for managing defects. The first step is to classify and prioritize: “Generally, teams will prioritize two types of bugs: those that cause a system to crash and those that are less severe but could be pervasive....Next, decide your target response time for each level of severity. If the quality management system is new, then the initial focus should be on fixing the most severe bugs within hours or days. As you use your system, you can");
            WriteLiteral(@" gather data on two key metrics, incoming bug rates and the productivity of the bug fixers, and adjust your targets as needed.” He says organizations also need to create a system where defects and the time required to resolve them can be reviewed at all levels, from the CEO on down.7
    ...
    As well, look for testing and tracking systems that use AI to detect errors early in the development process. It can optimize the number and types of tests that t");
            WriteLiteral("eams run, automate the testing process and use AI to analyze past defects and prevent them in the future.\r\n</p>");
        }
